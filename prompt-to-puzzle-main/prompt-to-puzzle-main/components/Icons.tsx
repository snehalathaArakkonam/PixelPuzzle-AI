...
export const GenerateIcon: React.FC = () => (
    ...
    >
        ...
        <path d="M12 2v1.5" />
        <path d="M12 20.5V22" />
        <path d="m4.929 4.929 1.061 1.06" />
        <path d="m18.01 18.01 1.06 1.06" />
        <path d="m4.929 19.071 1.06-1.06" />
...
export const InfoIcon: React.FC<{ className?: string }> = ({ className = "inline-block w-4 h-4" }) => (
